    ...
    <div class="row">
        <div class="col-lg-7 col-md-12 col-12">
            <div class="property_detail_content">
                ...
                <div class="property_description">
                    <div class="property_description_top">
                        ...
                        <!-- <div class="book_now_sect">
                            <a class="genBtn" href="javascript:void(0)">Book Now</a>
                        </div> -->
                    </div>
                ...
                <div class="property_Owner_section">
                    ...
                    <div class="book_now_sect">
                        <a class="genBtn" href="javascript:void(0)">Message</a>
                    </div>
                </div>
        ...
        <div class="col-lg-5 col-md-12 col-12">
            <div class="book_a_property_section">
                ...
                <form class="book_a_property_form" action="">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group propertyfield mb-3">
                                <label for="">Arrive</label>
                                <select class="form-select" aria-label="Default select example">
                                <option selected>5/25/2023</option>
                                <option value="1">5/26/2023</option>
                                <option value="2">5/27/2023</option>
                                <option value="3">5/28/2023</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <div class="book_now_sect">
                        <a class="genBtn" data-bs-toggle="modal" href="#exampleModalToggle" role="button">Book Now</a>
                    </div>
                </form>
            </div>
        </div>
